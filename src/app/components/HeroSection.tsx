        ...
        <div className="grid h-full grid-cols-12 items-center gap-4">
          ...
          <div className="absolute bg-white z-20">
            <div className="inline-block bg-surface-container-lowest p-10 shadow-editorial md:p-16">
              ...
              <h1 className="font-headline mb-8 text-5xl leading-tight text-on-surface md:text-7xl">
              Volver a tu <br />
                <span className="italic text-primary">centro</span>
              </h1>
  
              <p className="mb-10 max-w-sm text-lg leading-relaxed text-on-surface-variant">
