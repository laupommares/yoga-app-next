const classes = [
    {
      ...
      duration: "75min",
      description:
        "A foundational practice focused on alignment, holding poses to build strength and mental focus. Perfect for grounding.",
    ...
    },
    {
      ...
      duration: "60min",
      description:
        "Synchronized breath and movement. A dynamic sequence designed to create heat, release tension, and find your flow state.",
    ...
    },
    {
      ...
      duration: "90min",
      description:
        "Gentle stretches and restorative postures supported by props. A practice of total surrender and deep relaxation.",
      schedule: "Fridays at Sunset",
      image:
